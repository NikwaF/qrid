										...
										<tbody>
											...
											foreach ($data as $b) {
												...
												<tr>
													...
													<td>
														<a href="<?= base_url(); ?>admin/presensi/hapusqr/<?= $b['id']; ?>" class="btn btn-outline-dark btn-icon rounded-circle tombol-hapus" title="Hapus Produk">
