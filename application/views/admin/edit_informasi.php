	...
	<div id="content">
		<section class="style-default-bright">
			...
			<div class="section-body">
				...
				<div class="card">
					<div class="card-body">
						<form class="form-horizontal" role="form" action="<?= base_url('admin/informasi/edit'); ?>" method="post" enctype="multipart/form-data">
						    <input type="hidden" class="form-control" id="id" name="id" value="<?= $edit['id'] ?>">
							<div class="form-group" style="margin-bottom: 20px;">
								<label for="nama_barang" class="col-sm-2 control-label">Informasi</label>
								<div class="col-sm-10">
									<textarea class="form-control" id="informasi" name="informasi" placeholder="Masukkan Informasi"><?= $edit['deskripsi'] ?></textarea>
