	...
	<div id="content">
		<section class="style-default-bright">
			<div class="section-header">
				<h2 class="text-dark">Data File</h2>
			</div>
										...
										<tbody>
											...
											foreach ($barang as $b) {
												...
												<tr>
													...
													<td>
														<a href="<?= base_url(); ?>administrator/file/hapus/<?= $b['id']; ?>" class="btn btn-outline-dark btn-icon rounded-circle tombol-hapus" title="Hapus Produk">
