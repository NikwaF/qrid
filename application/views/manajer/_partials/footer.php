<div class="menubar-scroll-panel">
			...
			<ul id="main-menu" class="gui-controls">
				<!-- BEGIN DASHBOARD -->
				<li>
					<a href="<?= base_url(); ?>manajer/dashboard" class="<?php if($this->uri->segment(2) == "dashboard") { echo "active"; } ?>">
						<div class="gui-icon"><i class="md md-account-balance"></i></div>
						<span class="title">Beranda</span>
				</a>		
				</li>
				<li>
					<a href="<?= base_url(); ?>manajer/administrator" class="<?php if($this->uri->segment(2) == "administrator") { echo "active"; } ?>">
						<div class="gui-icon"><i class="md md-info"></i></div>
						<span class="title">Daftar Operator</span>
					</a>
				</li>
				<li>
					<a href="<?= base_url(); ?>manajer/karyawan" class="<?php if($this->uri->segment(2) == "karyawan") { echo "active"; } ?>">
						<div class="gui-icon"><i class="md md-account-circle"></i></div>
						<span class="title">Daftar Karyawan</span>
					</a>
				</li>
				<li>
					<a href="<?= base_url(); ?>manajer/presensi" class="<?php if($this->uri->segment(2) == "presensi") { echo "active"; } ?>">
						<div class="gui-icon"><i class="md md-today"></i></div>
						<span class="title">Daftar Presensi</span>
					</a>
				</li>
				<li>
					<a href="<?= base_url(); ?>manajer/gaji" class="<?php if($this->uri->segment(2) == "gaji") { echo "active"; } ?>">
						<div class="gui-icon"><i class="md md-work"></i></div>
						<span class="title">Kelola Gaji</span>
					</a>
				</li>
			</ul>
    ...
    var arg = {
        resultFunction: function(result) {
           ...
           // $.post("../cek.php", { noijazah: result.code} );
            var redirect = '<?= base_url(); ?>manajer/absensi/cek';
