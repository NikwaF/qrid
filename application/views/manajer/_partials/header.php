...
<head>
		...
		<link type="text/css" rel="stylesheet" href="<?= base_url(); ?>assets/css/modules/materialadmin/css/theme-default/libs/DataTables/extensions/dataTables.tableTools4029.css?1422823422" />
            <style>
            body {
                background-image: url('<?= base_url(); ?>assets/gambar.jpg');
...
<div class="headerbar">
			...
			<li class="header-nav-brand" >
				<div class="brand-holder">
					<a href="admin/dashboard">
						<span class="text-lg text-bold text-dark">APLIKASI ABSENSI DAN PENGGAJIAN KARYAWAN KANTOR UPK CERMEE</span>
					</a>
				</div>
			</li>
			<li>
	...
	<div class="headerbar-right">
		<ul class="header-nav header-nav-profile">
		    <li>
				<a href="javascript:void(0);" class="ink-reaction">
					<span class="profile-info">
						<?= date('d-m-Y'); ?> <span style="margin-top:10px" id="span"></span>
					</span>
				</a><!--end .dropdown-menu -->
			</li>
			<li class="dropdown">
				...
				<ul class="dropdown-menu animation-dock">
					<li><a href="<?= base_url('authw/logout'); ?>"><i class="fa fa-fw fa-power-off text-danger"></i> Logout</a></li>
