	...
	<div id="content">
		<section class="style-default-bright">
			<div class="section-header">
				<h2 class="text-dark">Data Jenis Foto</h2>
			</div>
			<div class="section-body">
				...
				<div class="row">
					<div class="col-md-8">
						<a data-target="#tambahJenis" data-toggle="modal" class="btn ink-reaction btn-raised btn-dark" style="margin-bottom: 10px;"><i class="fa fa-plus"></i> Tambah Jenis</a>
