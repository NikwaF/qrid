	...
	<div id="content">
		<section class="style-default-bright">
			<div class="section-header">
				<h2 class="text-dark">Edit Gaji</h2>
			</div>
			<div class="section-body">
				...
				<div class="card">
					<div class="card-body">
						<form class="form-horizontal" role="form" action="<?= base_url('manajer/gaji/edit'); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group" style="margin-bottom: 20px;">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="nominal" name="nominal" placeholder="Nama Lengkap" value="<?= $edit['nominal'] ?>">
