<div class="menubar-scroll-panel">
			...
			<ul id="main-menu" class="gui-controls">
				...
				<li>
					<a href="<?= base_url(); ?>user/tugas" class="<?php if($this->uri->segment(2) == "tugas") { echo "active"; } ?>">
						<div class="gui-icon"><i class="md md-info"></i></div>
						<span class="title">Tugas</span>
					</a>
				</li>
				<li>
					<a href="<?= base_url(); ?>user/jemput" class="<?php if($this->uri->segment(2) == "jemput") { echo "active"; } ?>">
						<div class="gui-icon"><i class="md md-info"></i></div>
						<span class="title">Antar Jemput</span>
					</a>
				</li>
			</ul>
