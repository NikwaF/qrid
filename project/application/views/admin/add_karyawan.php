	...
	<div id="content">
		<section class="style-default-bright">
			<div class="section-header">
				<h2 class="text-primary">Add Karyawan</h2>
			</div>
			<div class="section-body">
				...
				<div class="card">
					<div class="card-body">
						<form class="form-horizontal" role="form" action="<?= base_url('admin/karyawan/tambah'); ?>" method="post" enctype="multipart/form-data">
