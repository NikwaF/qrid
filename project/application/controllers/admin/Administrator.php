...
class Administrator extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'SI Absensi | Operator List';
    ...
    public function tambah()
    {
        ...
        $data['title'] = 'SI Absensi | Add Operator';
        $data['user_session'] = $this->db->get_where('tbl_users', ['nik' => $this->session->userdata('nik')])->row_array();
    ...
    public function tambah_divisi()
    {
        ...
        $data['title'] = 'SI Absensi | Add Division';
        $data['user_session'] = $this->db->get_where('tbl_users', ['nik' => $this->session->userdata('nik')])->row_array();
    ...
    public function edit()
    {
        ...
        $data['title'] = 'SI Absensi | Edit Operator';
    ...
    public function edit_divisi()
    {
        ...
        $data['title'] = 'SI Absensi | Edit Divisi';
        $id = $this->uri->segment(4);
        $data['user_session'] = $this->db->get_where('tbl_users', ['nik' => $this->session->userdata('nik')])->row_array();
